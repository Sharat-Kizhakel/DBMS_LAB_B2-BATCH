...
SELECT STUDENT.*,SEMSEC.SEM,SEMSEC.SEC FROM STUDENT,SEMSEC,CLASS WHERE STUDENT.USN=CLASS.USN AND CLASS.SSID=SEMSEC.SSID AND SEMSEC.SEM='4' AND SEMSEC.SEC='C';
/*2. Compute the total number of male and female students in each semester and in each section. */
SELECT SEMSEC.SEM,SEMSEC.SEC,STUDENT.gender,COUNT(GENDER) FROM STUDENT,CLASS,SEMSEC WHERE STUDENT.USN=CLASS.USN AND CLASS.SSID=SEMSEC.SSID GROUP BY SEMSEC.SEM,SEMSEC.SEC,STUDENT.GENDER ORDER BY SEM;
/*3. Create a view of Test1 marks of student USN ‘1BI15CS101’ in all subjects. */
DROP VIEW TEST1;
CREATE VIEW TEST1 AS SELECT TEST1,SUBJECT.SUBCODE FROM IAMARKS,SUBJECT WHERE IAMARKS.SUBCODE=SUBJECT.SUBCODE AND IAMARKS.USN='1RN13CS091' GROUP BY SUBJECT.SUBCODE;
SELECT*FROM TEST1;
...
CASE 
 ...
 ELSE 'Weak'
 END AS CAT
 FROM IAMARKS I,STUDENT S,SEMSEC SC WHERE SC.SEM=8 AND S.USN=I.USN AND I.SSID=SC.SSID;  
